...
let links = [{
        "userFriendlyName": "XR Studio",
        "url": "https://xrstudio.com"
    }, {
        "userFriendlyName": "Half Baked City",
        "url": "https://halfbaked.city"
    }];

class ConnectedWebsitesPage {
    ...
    _addPageContent() {
        ...
        for(let i = 0; i < links.length; i++) {
            ...
            let interactable = new PointerInteractable(linkButton, () => {
                window.location.href = links[i].url;
            });
            this._interactables.push(interactable);
        }
